...
--
-- Host: localhost
-- Generation Time: Jan 22, 2025 at 03:15 AM
...
--
-- Database: `iswebokay_epdp_content`
--
...
CREATE TABLE `process` (
  ...
  `tajuk` text DEFAULT NULL,
  `kdg` text DEFAULT NULL,
  `cstd` text DEFAULT NULL,
  ...
  `emk` text DEFAULT NULL,
  `nilai` text DEFAULT NULL,
  `abm` text DEFAULT NULL,
  `kb` text DEFAULT NULL,
  `peta` text DEFAULT NULL,
  `tsm` text DEFAULT NULL,
  `tahap` varchar(50) DEFAULT NULL,
  `akt21` text DEFAULT NULL,
  `p21` text DEFAULT NULL,
  `praujian` text DEFAULT NULL,
  `pascaujian` text DEFAULT NULL,
  `6k` text DEFAULT NULL,
  `aspirasi` text DEFAULT NULL,
  `inputRefleksi` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`inputRefleksi`)),
  `pbd` text DEFAULT NULL,
  `penggal` int(11) NOT NULL DEFAULT 0,
  `minggu` int(11) NOT NULL DEFAULT 0,
  `nameRefleksi` varchar(225) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(25, 'dangxuong@gmail.com', 'dangxuong@gmail.com', '$2y$10$sCbbke.UQ.bzqWe3VHSvKu3wQluVFlldif1o2ciGB2kfy2w49Yap2', '0976594504', 3, 1, 1, 358),
...
(31, 'hh@gmail.com', 'hh', '$2y$10$Tf2OKrPnBN8D/dMK4.XAJ.5tMeVzOClf0XTvST3A2oU/pY0QZH876', '12345678', 0, 1, 1, 361);
